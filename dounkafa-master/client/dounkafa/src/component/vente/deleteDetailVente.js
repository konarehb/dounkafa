...
const DeleteDetailVente = ()=> {
    ...
    const deleteDetailVente= async (e)=>{
        e.preventDefault();
        try{
            await axios.delete(`http://localhost:5000/deatailCommandes/${detCom_id}`);
    ...
    return(
        <form onSubmit={deleteDetailVente}>
...
export default DeleteDetailVente;