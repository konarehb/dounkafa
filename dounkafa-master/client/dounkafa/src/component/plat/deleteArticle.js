        ...
        <form onSubmit={deleteArticle}>
            <div className="form-row">
                ...
                <div className="col-md-4 mb-3">
                    ...
                    <select value={categorie_id} onChange={(e)=>setCategorie_id(e.target.value)} className='form-select' disabled>
                        <option></option>
                ...
                <div className="col-md-4 mb-3">
                        ...
                        accept="/images/png,/images/jpg,/images/jpeg" id="photo" disabled/> 
                </div> 
                <div className="col-md-4 mb-3">
                <button type="submit" className="btn btn-danger pl-2">Supprimer</button>
                </div>
